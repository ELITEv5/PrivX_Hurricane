...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║           P R I V X   H U R R I C A N E   S H I E L D   V 3     ║
 ...
 * ║                                                                  ║
 * ║  V3 change: miningRewardAmount tiers are 10× lower than V2 to    ║
 * ║  keep rewards sustainable at higher PRIVX valuations.            ║
 * ║  Pay stables use denomination-proportional rewards               ║
 * ║  (denomination_usd × 10 PRIVX). Hurricane tokens use fixed       ║
 * ║  tiers: d0→100, d1→1K, d2→10K, d3→100K PRIVX.                   ║
 * ║  Pay $10 = Hurricane d0 (100 PRIVX each) — contracts are reused. ║
 * ║                                                                  ║
 ...
 * ║                                                                  ║
 * ║  Pay miningRewardAmount (denomination_usd × 10 PRIVX):           ║
 * ║    $1→10  $5→50  $10→100  $20→200  $50→500  $100→1,000           ║
 * ║                                                                  ║
 * ║  Hurricane miningRewardAmount (fixed tiers):                     ║
 * ║    d0 →    100e18   d1 →  1_000e18                               ║
 * ║    d2 → 10_000e18   d3 → 100_000e18                              ║
 * ║                                                                  ║
...
contract PrivX_Shield_V3 is ReentrancyGuard {
    ...
    /// @notice BN254 scalar field size — public signals must be strictly less than this.
    ...
    /// @notice Amount passed to mineReward.
    ///         Pay stables: denomination_usd × 10e18 (e.g. $10 → 100e18 PRIVX)
    ///         Hurricane:   fixed tiers d0=100e18 / d1=1_000e18 / d2=10_000e18 / d3=100_000e18
     ...
     * @param _miningRewardAmount Amount passed to mineReward.
     *                            Pay stables: denomination_usd × 10e18
     *                            Hurricane:   d0=100e18, d1=1_000e18, d2=10_000e18, d3=100_000e18
     */
    constructor(
